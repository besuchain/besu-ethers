...
async function example() {
  ...
  console.log(
    `Public hash of deployment transactions ${contractNode1.deployPrivateTransaction.publicHash}`
  );
  ...
  const contractNode2 = new BesuEthers.PrivateContract(
  ...
  const contractNode3 = new BesuEthers.PrivateContract(
    contractNode1.address,
    { privateFor: privacyGroupId },
    abi,
    walletNode3
