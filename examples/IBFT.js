...
async function example() {
  ...
  validators = await provider.ibftGetValidatorsByBlockHash(
  ...
  let success = await provider.ibftProposeValidatorVote(
  ...
  success = await provider.ibftProposeValidatorVote(
