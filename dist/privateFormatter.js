...
var PrivateFormatter = /** @class */ (function (_super) {
    ...
    PrivateFormatter.prototype.getDefaultFormats = function () {
        ...
        return __assign({}, superFormats, {
            ...
            privateTransaction: __assign({}, superFormats.transaction, {
                publicHash: providers_1.Formatter.allowNull(null, null),
                privateHash: this.hash.bind(this),
                // Add extra EEA fields
                privateFrom: providers_1.Formatter.allowNull(this.privateAddress, null),
