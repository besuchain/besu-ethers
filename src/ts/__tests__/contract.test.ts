...
describe('Deploy contract using contract factory', () => {
    ...
    describe('Create privacy group before creating the contract', () => {
        ...
        test('Create privacy group', async () => {
            privacyGroupId = await providerNode1.createPrivacyGroup([node1, node2], 'Top Secret', 'Super secret group');
        ...
        test('Check privacy group was created', async () => {
            const privacyGroups = await providerNode1.findPrivacyGroup([node1, node2]);
        ...
        test('Get private transaction count after deploy', async () => {
            const count = await providerNode1.getPrivateTransactionCount(signerAddress, privacyGroupOptions);
        ...
        describe('node 2 interacts to existing contract deployed from node 1 using', () => {
            describe('contract connect function', () => {
                test('instantiate contract', async () => {
                    contractNode2 = new PrivateContract(
                        contractNode1.address,
                        privacyGroupOptions,
                        testContractAbi,
                        providerNode2,
                    );
