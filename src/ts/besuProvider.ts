  ...
  perform(method: string, params: any): Promise<any> {
    switch (method) {
      ...
      case 'ibftDiscardValidatorVote':
        return this.send('ibft_discardValidatorVote', [params.validatorAddress]);
      ...
      case 'ibftGetValidatorsByBlockNumber':
        return this.send('ibft_getValidatorsByBlockNumber', [params.blockParameter]);

      case 'ibftProposeValidatorVote':
        return this.send('ibft_proposeValidatorVote', [params.validatorAddress, params.add]);
